...
class ConversationState(MessagesState):
    ...
    admin_confirmation_processed: NotRequired[
        bool
    ]  # True after user has confirmed and second tool call is executing
    admin_original_query: NotRequired[
        Optional[str]
    ]  # Original user query that triggered admin tool
