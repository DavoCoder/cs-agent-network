...
class VectorStoreManager:
    ...
    def __init__(self, index_name: str = "customer-support-kb", dimension: int = 1536):
    ...
    def similarity_search(
        self, query: str, category: str, k: int = 3, metadata_filter: Optional[dict] = None
    ) -> List[Document]:
    ...
    def add_documents(
        self, documents: List[Document], category: str, metadata: Optional[dict] = None
    ):
    ...
    def add_texts(self, texts: List[str], metadatas: List[dict], category: str):
...
def search_vector_kb(query: str, category: str, k: int = 3) -> List[Document]:
