...
class TicketClassification(BaseModel):
    ...
    confidence: float = Field(
        ge=0.0, le=1.0, description="Confidence score from 0.0 to 1.0 for the classification"
    )
    needs_human_review: bool = Field(description="Whether this request might need human review")
