...
TEMPERATURE_DESCRIPTION = "The temperature to use for the agent. Must be between 0.0 and 1.0"
DEFAULT_TEMPERATURE = 0.1

TOOL_CALL_LIMIT_DESCRIPTION = "The tool call limit for the agent. Must be an integer greater than 0"
...
class Configuration(BaseModel):
    ...
    technical_agent_system_prompt: str = Field(
        ...
        description=SYSTEM_PROMPT_DESCRIPTION,
        json_schema_extra={"langgraph_nodes": ["technical"], "langgraph_type": "prompt"},
    )
    ...
    billing_system_prompt: str = Field(
        ...
        description=SYSTEM_PROMPT_DESCRIPTION,
        json_schema_extra={"langgraph_nodes": ["billing"], "langgraph_type": "prompt"},
    )
    ...
    administration_system_prompt: str = Field(
        ...
        description=SYSTEM_PROMPT_DESCRIPTION,
        json_schema_extra={"langgraph_nodes": ["administration"], "langgraph_type": "prompt"},
    )
    ...
    admin_confirmation_message: str = Field(
        ...
        json_schema_extra={"langgraph_nodes": ["human_review"], "langgraph_type": "prompt"},
    )
    ...
    assessment_system_prompt: str = Field(
        ...
        description=SYSTEM_PROMPT_DESCRIPTION,
        json_schema_extra={"langgraph_nodes": ["assessment"], "langgraph_type": "prompt"},
    )
