...
class TestTrajectoryMatch:
    ...
    def test_exact_match(self):
        ...
        outputs = {"trajectory": ["supervisor", "technical", "technical_tools", "technical", "assessment"]}
        reference = {"trajectory": ["supervisor", "technical", "technical_tools", "technical", "assessment"]}
